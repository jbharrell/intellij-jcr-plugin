...
public class JcrTreeNode extends DefaultMutableTreeNode {
	private static final Logger log = com.intellij.openapi.diagnostic.Logger.getInstance(JcrTreeNode.class);
	 ...
	 */
	public boolean populateChildren(boolean descend) {
	 ...
	 * @return Whether or not nodes were added to the tree.
	 */
	public boolean populateChildren(boolean descend, Session session) {
